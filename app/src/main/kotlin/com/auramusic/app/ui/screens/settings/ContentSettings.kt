...
import com.auramusic.app.constants.ContentLanguageKey
...
import com.auramusic.app.constants.ProxyEnabledKey
import com.auramusic.app.constants.ProxyPasswordKey
import com.auramusic.app.constants.ProxyTypeKey
import com.auramusic.app.constants.ProxyUrlKey
import com.auramusic.app.constants.ProxyUsernameKey
...
import com.auramusic.app.constants.ShowArtistDescriptionKey
import com.auramusic.app.constants.ShowArtistSubscriberCountKey
import com.auramusic.app.constants.ShowMonthlyListenersKey
    ...
    Column(
        ...
        Material3SettingsGroup(
            ...
            items = listOf(
                ...
                Material3SettingsItem(
                    icon = painterResource(R.drawable.lyrics),
                    title = { Text(stringResource(R.string.enable_rush_lyrics)) },
                    description = { Text(stringResource(R.string.enable_rush_lyrics_desc)) },
                    trailingContent = {
                        Switch(
                            ...
                            thumbContent = {
                                Icon(
                                    painter = painterResource(
                                        id = if (enableRushLyrics) R.drawable.check else R.drawable.close
                                    ),
                                    contentDescription = null,
                                    modifier = Modifier.size(SwitchDefaults.IconSize)
                                )
                    ...
                    onClick = { onEnableRushLyricsChange(!enableRushLyrics) }
                ),
                Material3SettingsItem(
                    icon = painterResource(R.drawable.lyrics),
